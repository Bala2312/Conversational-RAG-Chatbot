...
qa_system_prompt = (
    ...
    "- If the user introduces themselves, states their name, or references their job/role, you MUST acknowledge it politely and remember it using the chat history.\n"
    "- Do NOT look in the document context for user names or personal chat details.\n\n"
